...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "projects.readMore": "Ver Detalhes",
    ...
    "admin.profile.bio": "Pequena Biografia (Seção Hero)",
    "admin.profile.aboutMe": "Sobre Mim (Seção Sobre)",
    "admin.titlePt": "Título (PT)",
  ...
  en: {
    ...
    "admin.profile.bio": "Short Bio (Hero section)",
    "admin.profile.aboutMe": "About Me (About section)",
    "admin.titlePt": "Title (PT)",
    "admin.unread": "Unread",
    "admin.add": "Add",
    "admin.edit": "Edit",
    "admin.delete": "Delete",
